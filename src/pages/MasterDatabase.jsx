...
const sections = [
  {
    ...
    description: 'Manage transformation data and records.',
    icon: '🔄',
    path: '/master-database/transformation',
  },
  {
    title: 'Government',
    description: 'Government-related records and compliance data.',
    icon: '🏛️',
    path: '/master-database/government',
  },
  {
    title: 'Industry',
    description: 'Industry stakeholder data and statistics.',
    icon: '🏭',
    path: '/master-database/industry',
  },
  {
    title: 'Associated Members',
    description: 'Associated member organisations and contacts.',
    icon: '🤝',
    path: '/master-database/associated-members',
  },
  {
    title: 'Registered Abattoirs',
    description: 'Directory of registered abattoir facilities.',
    icon: '📍',
    ...
    <div style={s.page}>
      ...
      <header style={s.header}>
        ...
        <div style={s.topBarCenter}>
          <span style={s.pageTitle}>Master Database</span>
        </div>
      ...
      {/* Content */}
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '32px 24px 48px', width: '100%' }}>
        <p style={{ fontSize: '1rem', fontWeight: 600, color: '#323130', margin: '0 0 16px' }}>Master Database</p>
        <div style={s.grid}>
...
const s = {
  ...
  hero: { textAlign: 'center', padding: '40px 24px 28px' },
  heroTitle: { fontSize: '1.6rem', fontWeight: 600, color: '#323130', margin: '0 0 8px' },
  heroSub: { fontSize: '0.95rem', color: '#605e5c', margin: 0 },
  grid: {
    display: 'grid',
