...
const sections = [
  {
    title: 'STT Training Report',
    description: 'STT training records and reporting data.',
    icon: '📋',
    ...
    <div style={s.page}>
      <header style={s.header}>
        ...
        <div style={s.topBarCenter}>
          <span style={s.pageTitle}>Training Report</span>
        </div>
      ...
      <main style={s.main}>
        <p style={s.sectionLabel}>Training Report</p>
        <div style={s.grid}>
